...
- **Variations (Change Control)** - Formal change requests with dual-signature approval
...
- Fixed RAID Log save error (relation object stripping)
- Fixed baseline signing RLS policy for Customer PM
- Calendar bug fixes and click navigation enhancements
- Events row in week view for milestones/deliverables

### Version 5.1 (December 2025)
- Variations (Change Control) module with dual-signature workflow
- Delete support for draft, submitted, and rejected variations
- CR document generation wizard
- Comprehensive variation management documentation
