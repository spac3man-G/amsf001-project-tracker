import{a as E,T as q,j as e,A as J,C as Q,u as _e,c as Ne,d as ye,x as w,L as we,S as Se,y as x}from"./index-DBy7juAg.js";import{r as h,i as Ce,d as Te}from"./vendor-react-BUTV5ZEl.js";import{C as De}from"./ConfirmDialog-C4qxA-j9.js";import{a as D,f as A,b as _}from"./formatters-BTbCMDgc.js";import{am as L,az as Z,c as ee,F as z,a as Ee,D as $e,R as O,a5 as X,ah as Pe,T as ke,a8 as Re,i as Ae,Q as ze,p as V,Y as Ie,U as Y,aR as R,X as Fe,A as Ve}from"./vendor-icons-L8EmaAR6.js";import"./deliverableCalculations-DFwkFn9z.js";import"./timesheetCalculations-xsKvrrM0.js";import"./vendor-supabase-6faYzd5A.js";const S={HEADER:"header",SECTION_TITLE:"section_title",FIELD_ROW:"field_row",TEXT_BLOCK:"text_block",TABLE:"table",SIGNATURE_BLOCK:"signature_block",PAGE_BREAK:"page_break"};class Me{async renderToHtml(s,t){const r=[],i=s.template_definition;if(!i||!i.sections)return{html:"<p>No template definition</p>",warnings:["Missing template definition"]};const l=this.buildContext(s,t),c=i.sections.map((p,o)=>{try{return this.renderSection(p,l,"html",i.styles)}catch(f){return r.push(`Section ${o+1} (${p.type}): ${f.message}`),`<!-- Error rendering section ${o+1} -->`}}).join(`
...
<body>
  ${s}
    ...
    `.trim()}}const M=new Me;function Le({variation:n,onClose:s}){const{currentProject:t}=E(),r=h.useRef(null),i=q[n.variation_type];function l(){const c=r.current,m=window.open("","_blank");m.document.write(`
      <!DOCTYPE html>
      <html>
      <head>
