import{a as E,_ as q,j as e,a0 as J,a1 as Q,u as _e,c as Ne,d as ye,X as w,L as we,Z as Se,Y as x}from"./index-CvJ0uIlS.js";import{r as h,i as Ce,d as Te}from"./vendor-react-BUTV5ZEl.js";import{C as De}from"./ConfirmDialog-DVEUKBdx.js";import{a as D,f as A,b as _}from"./formatters-BTbCMDgc.js";import{al as L,ay as Z,c as ee,F as z,a as Ee,D as $e,R as O,a4 as Y,ag as Pe,T as ke,a7 as Re,i as Ae,Q as ze,p as V,Y as Ie,U as K,aP as R,X as Fe,A as Ve}from"./vendor-icons-qkJ_CSr6.js";import"./deliverableCalculations-DQK4ExpM.js";import"./timesheetCalculations-B1UhkDwB.js";import"./vendor-supabase-6faYzd5A.js";const S={HEADER:"header",SECTION_TITLE:"section_title",FIELD_ROW:"field_row",TEXT_BLOCK:"text_block",TABLE:"table",SIGNATURE_BLOCK:"signature_block",PAGE_BREAK:"page_break"};class Me{async renderToHtml(s,t){const r=[],i=s.template_definition;if(!i||!i.sections)return{html:"<p>No template definition</p>",warnings:["Missing template definition"]};const l=this.buildContext(s,t),c=i.sections.map((p,o)=>{try{return this.renderSection(p,l,"html",i.styles)}catch(f){return r.push(`Section ${o+1} (${p.type}): ${f.message}`),`<!-- Error rendering section ${o+1} -->`}}).join(`
